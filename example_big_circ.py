...
if __name__ == "__main__":
    # lst = [6,8,10,12]
    circs = {"bv":[14,16,18,20,22,24,26],"supremacy":[12,15,16,20,24,25],"adder":[14,16,18,20,22,24,26],"hwea":[14,16,18,20,22,24,26],"ghz":[14,16,18,20,22,24,26]}
    #circs = {"adder":[14,16,18,20,22,24,26],"hwea":[14,16,18,20,22,24,26],"ghz":[14,16,18,20,22,24,26]}
    ...
    for circ_type,lst in circs.items():
        for circ_size in lst:
            ...
            devqcc = devqcc(
                ...
                circuit=circ,
                cutter_constraints={
                    "max_subcircuit_width": min(circ_size,20),
